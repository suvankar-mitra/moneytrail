...
public class AuthControllerIT {
    ...
    public void register_shouldReturn201_whenValidRequest() throws Exception {
        ...
        mockMvc.perform(post(registerBaseUrl).contentType(MediaType.APPLICATION_JSON).content(validJsonRequest))
    ...
    public void register_shouldReturn409_whenEmailAlreadyExists() throws Exception {
        ...
        mockMvc.perform(post(registerBaseUrl).contentType(MediaType.APPLICATION_JSON).content(dupEmailJsonRequest))
    ...
    public void login_shouldReturn200AndJwtToken_whenValidCredential() throws Exception {
        ...
        mockMvc.perform(post(loginBaseUrl).contentType(MediaType.APPLICATION_JSON).content(validJsonRequest))
